...
export const validateCreateClient: ValidationChain[] = [
  ...
  body("Descizione metodo pagamento")
    ...
    .notEmpty()
    .withMessage(
      "Descizione metodo pagamento is required and must be a string"
    ),
  body("AG")
    .isString()
    .notEmpty()
...
export const validateUpdateClient: ValidationChain[] = [
  ...
  body("CODICE").optional().isString().withMessage("CODICE must be a string"),
  body("RAGIONE SOCIALE")
    .optional()
    .isString()
  ...
  body("MP").optional().isString().withMessage("MP must be a string"),
  body("Descizione metodo pagamento")
    .optional()
    .isString()
    .withMessage("Descizione metodo pagamento must be a string"),
  body("AG").optional().isString().withMessage("AG must be a string"),
];
