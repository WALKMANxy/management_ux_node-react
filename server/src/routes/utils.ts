...
router.get("/scramble-movements", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send("Movements data update process completed successfully.");
  } catch (error) {
...
router.get("/scramble-employees", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send("Employees data scrambling process completed successfully.");
  } catch (error) {
...
router.get("/scramble-admins", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send("Admins data scrambling process completed successfully.");
  } catch (error) {
