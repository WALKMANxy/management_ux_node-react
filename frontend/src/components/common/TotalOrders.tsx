...
import { Typography, Paper, Box, Avatar, Grid, Button, useMediaQuery } from '@mui/material';
          ...
          <Grid item sx={{ mb: 0.5 }}>
            <Grid container alignItems="center" direction={isMobile ? 'column' : 'row'}>
              ...
              <Grid item xs={12} md={6}>
                {timeValue ? (
                  <Chart {...ChartData(monthlyCategories, monthlyOrders)} height="150" />
                ) : (
                  <Chart {...ChartData(yearlyCategories, yearlyOrders)} height="150" />
                )}
              </Grid>
            </Grid>
          </Grid>
