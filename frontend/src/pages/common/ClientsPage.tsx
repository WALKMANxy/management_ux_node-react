...
import { Box, Typography, Paper, Collapse, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, IconButton, Card, CardContent, Grid } from '@mui/material';
...
const mockClientsList = [
  { id: '1', name: 'Client 1', province: 'CT', phone: '123-456-7890', ordersThisMonth: 5, revenueThisMonth: '$5000', unpaidRevenue: '$1000' },
  { id: '2', name: 'Client 2', province: 'PA', phone: '123-456-7891', ordersThisMonth: 3, revenueThisMonth: '$3000', unpaidRevenue: '$500' },
  { id: '3', name: 'Client 3', province: 'NY', phone: '123-456-7892', ordersThisMonth: 4, revenueThisMonth: '$4000', unpaidRevenue: '$1500' },
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', p: 2 }}>
              ...
              <Table>
                ...
                <TableBody>
                  {mockClientsList.map((client) => (
                    <TableRow key={client.id} onClick={() => handleClientSelect(client.name)} hover>
                      ...
                      <TableCell><button onClick={() => handleClientSelect(client.name)}>View</button></TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
      ...
      <Paper elevation={3}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 2 }}>
          ...
          <IconButton onClick={() => setClientDetailsCollapsed(!isClientDetailsCollapsed)}>
              ...
              <Card variant="outlined">
                <CardContent>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Typography variant="h6" gutterBottom>Visits History</Typography>
