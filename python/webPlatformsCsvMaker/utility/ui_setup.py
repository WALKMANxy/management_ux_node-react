...
def setup_ui(main_window, base_path):
    ...
    tulero_markup_layout = QVBoxLayout()
    widgets["tulero_markup_label"] = QLabel(_("Select Markup for Tulero (%)"))
    tulero_markup_layout.addWidget(widgets["tulero_markup_label"])
    widgets["tulero_markup_entry"] = QLineEdit()
    widgets["tulero_markup_entry"].setPlaceholderText(_("Enter percentage (10-35%)"))
    tulero_markup_layout.addWidget(widgets["tulero_markup_entry"])
    markup_layout.addLayout(tulero_markup_layout)

    # Shipping cost input for Tulero
    tulero_shipping_layout = QVBoxLayout()
    widgets["tulero_shipping_label"] = QLabel(_("Select Shipping Cost for Tulero (€)"))
    tulero_shipping_layout.addWidget(widgets["tulero_shipping_label"])
    widgets["tulero_shipping_entry"] = QLineEdit()
    widgets["tulero_shipping_entry"].setPlaceholderText(_("Enter cost (7.0-20.0)"))
    tulero_shipping_layout.addWidget(widgets["tulero_shipping_entry"])
    shipping_layout.addLayout(tulero_shipping_layout)

    # Markup input for Tyre24 (Italy)
    tyre24_markup_it_layout = QVBoxLayout()
    widgets["tyre24_markup_it_label"] = QLabel(_("Select Markup for Tyre24 (Italy) (%)"))
    tyre24_markup_it_layout.addWidget(widgets["tyre24_markup_it_label"])
    widgets["tyre24_markup_it_entry"] = QLineEdit()
    widgets["tyre24_markup_it_entry"].setPlaceholderText(_("Enter percentage (10-35%)"))
    tyre24_markup_it_layout.addWidget(widgets["tyre24_markup_it_entry"])
    markup_layout.addLayout(tyre24_markup_it_layout)

    # Shipping cost input for Tyre24 (Italy)
    tyre24_shipping_it_layout = QVBoxLayout()
    widgets["tyre24_shipping_it_label"] = QLabel(_("Select Shipping Cost for Tyre24 (Italy) (€)"))
    tyre24_shipping_it_layout.addWidget(widgets["tyre24_shipping_it_label"])
    widgets["tyre24_shipping_it_entry"] = QLineEdit()
    widgets["tyre24_shipping_it_entry"].setPlaceholderText(_("Enter cost (7.0-20.0)"))
    tyre24_shipping_it_layout.addWidget(widgets["tyre24_shipping_it_entry"])
    shipping_layout.addLayout(tyre24_shipping_it_layout)

    # Markup input for Tyre24 (Germany)
    tyre24_markup_de_layout = QVBoxLayout()
    widgets["tyre24_markup_de_label"] = QLabel(_("Select Markup for Tyre24 (Germany) (%)"))
    tyre24_markup_de_layout.addWidget(widgets["tyre24_markup_de_label"])
    widgets["tyre24_markup_de_entry"] = QLineEdit()
    widgets["tyre24_markup_de_entry"].setPlaceholderText(_("Enter percentage (10-35%)"))
    tyre24_markup_de_layout.addWidget(widgets["tyre24_markup_de_entry"])
    markup_layout.addLayout(tyre24_markup_de_layout)

    # Shipping cost input for Tyre24 (Germany)
    tyre24_shipping_de_layout = QVBoxLayout()
    widgets["tyre24_shipping_de_label"] = QLabel(_("Select Shipping Cost for Tyre24 (Germany) (€)"))
    tyre24_shipping_de_layout.addWidget(widgets["tyre24_shipping_de_label"])
    widgets["tyre24_shipping_de_entry"] = QLineEdit()
    widgets["tyre24_shipping_de_entry"].setPlaceholderText(_("Enter cost (7.0-20.0)"))
    tyre24_shipping_de_layout.addWidget(widgets["tyre24_shipping_de_entry"])
    shipping_layout.addLayout(tyre24_shipping_de_layout)
